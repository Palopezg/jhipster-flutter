...
import com.mycompany.myapp.repository.GrupoEmprendimientoRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.GrupoEmprendimiento}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class GrupoEmprendimientoResource {
    ...
    public ResponseEntity<GrupoEmprendimiento> updateGrupoEmprendimiento(@RequestBody GrupoEmprendimiento grupoEmprendimiento) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, grupoEmprendimiento.getId().toString()))
            .body(result);
    }
