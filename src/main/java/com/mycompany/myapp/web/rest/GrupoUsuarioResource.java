...
import com.mycompany.myapp.repository.GrupoUsuarioRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.GrupoUsuario}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class GrupoUsuarioResource {
    ...
    public ResponseEntity<GrupoUsuario> updateGrupoUsuario(@RequestBody GrupoUsuario grupoUsuario) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, grupoUsuario.getId().toString()))
            .body(result);
    }
