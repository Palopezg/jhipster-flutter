...
import com.mycompany.myapp.repository.NSERepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.NSE}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NSEResource {
    ...
    public ResponseEntity<NSE> updateNSE(@RequestBody NSE nSE) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, nSE.getId().toString()))
            .body(result);
    }
