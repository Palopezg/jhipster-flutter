...
import com.mycompany.myapp.repository.MasterTipoEmpRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.MasterTipoEmp}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class MasterTipoEmpResource {
    ...
    public ResponseEntity<MasterTipoEmp> updateMasterTipoEmp(@RequestBody MasterTipoEmp masterTipoEmp) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, masterTipoEmp.getId().toString()))
            .body(result);
    }
