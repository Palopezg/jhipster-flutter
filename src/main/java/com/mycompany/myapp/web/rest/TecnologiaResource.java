...
import com.mycompany.myapp.repository.TecnologiaRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Tecnologia}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TecnologiaResource {
    ...
    public ResponseEntity<Tecnologia> updateTecnologia(@RequestBody Tecnologia tecnologia) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tecnologia.getId().toString()))
            .body(result);
    }
