...
import com.mycompany.myapp.domain.GrupoAlarma;
import com.mycompany.myapp.repository.GrupoAlarmaRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.GrupoAlarma}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class GrupoAlarmaResource {
    ...
    public ResponseEntity<GrupoAlarma> updateGrupoAlarma(@Valid @RequestBody GrupoAlarma grupoAlarma) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, grupoAlarma.getId().toString()))
            .body(result);
    }
