...
import com.mycompany.myapp.repository.TipoEmpRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.TipoEmp}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TipoEmpResource {
    ...
    public ResponseEntity<TipoEmp> updateTipoEmp(@RequestBody TipoEmp tipoEmp) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tipoEmp.getId().toString()))
            .body(result);
    }
