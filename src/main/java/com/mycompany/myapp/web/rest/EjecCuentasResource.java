...
import com.mycompany.myapp.repository.EjecCuentasRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.EjecCuentas}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EjecCuentasResource {
    ...
    public ResponseEntity<EjecCuentas> updateEjecCuentas(@RequestBody EjecCuentas ejecCuentas) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, ejecCuentas.getId().toString()))
            .body(result);
    }
