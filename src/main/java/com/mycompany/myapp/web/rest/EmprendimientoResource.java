...
import com.mycompany.myapp.repository.EmprendimientoRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Emprendimiento}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmprendimientoResource {
    ...
    public ResponseEntity<Emprendimiento> updateEmprendimiento(@RequestBody Emprendimiento emprendimiento) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, emprendimiento.getId().toString()))
            .body(result);
    }
