  ...
  return (
    <div>
      <h2 id="grupo-usuario-heading">
        <Translate contentKey="jhipsterFlutterApp.grupoUsuario.home.title">Grupo Usuarios</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterFlutterApp.grupoUsuario.home.createLabel">Create new Grupo Usuario</Translate>
        </Link>
      </h2>
        ...
        {grupoUsuarioList && grupoUsuarioList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterFlutterApp.grupoUsuario.home.notFound">No Grupo Usuarios found</Translate>
            </div>
          )
        )}
      </div>
