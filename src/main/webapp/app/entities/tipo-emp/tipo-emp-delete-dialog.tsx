...
export const TipoEmpDeleteDialog = (props: ITipoEmpDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFlutterApp.tipoEmp.delete.question">
        <Translate contentKey="jhipsterFlutterApp.tipoEmp.delete.question" interpolate={{ id: tipoEmpEntity.id }}>
          Are you sure you want to delete this TipoEmp?
        </Translate>
      </ModalBody>
      <ModalFooter>
