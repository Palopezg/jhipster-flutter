...
export const Pauta = (props: IPautaProps) => {
  ...
  return (
    <div>
      <h2 id="pauta-heading">
        <Translate contentKey="jhipsterFlutterApp.pauta.home.title">Pautas</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterFlutterApp.pauta.home.createLabel">Create new Pauta</Translate>
        </Link>
      </h2>
        ...
        {pautaList && pautaList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterFlutterApp.pauta.home.notFound">No Pautas found</Translate>
            </div>
          )
        )}
      </div>
