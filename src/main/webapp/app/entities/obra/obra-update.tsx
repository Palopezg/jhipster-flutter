  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterFlutterApp.obra.home.createOrEditLabel">
            <Translate contentKey="jhipsterFlutterApp.obra.home.createOrEditLabel">Create or edit a Obra</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : obraEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="obra-tipoObra">
                  <Translate contentKey="jhipsterFlutterApp.obra.tipoObra">Tipo Obra</Translate>
                </Label>
                <AvInput id="obra-tipoObra" type="select" className="form-control" name="tipoObra.id">
                  <option value="" key="0" />
                  {tipoObras
