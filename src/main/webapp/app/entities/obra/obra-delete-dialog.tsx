...
export const ObraDeleteDialog = (props: IObraDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFlutterApp.obra.delete.question">
        <Translate contentKey="jhipsterFlutterApp.obra.delete.question" interpolate={{ id: obraEntity.id }}>
          Are you sure you want to delete this Obra?
        </Translate>
      </ModalBody>
      <ModalFooter>
