  ...
  return (
    <div>
      <h2 id="estado-heading">
        <Translate contentKey="jhipsterFlutterApp.estado.home.title">Estados</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterFlutterApp.estado.home.createLabel">Create new Estado</Translate>
        </Link>
      </h2>
        ...
        {estadoList && estadoList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterFlutterApp.estado.home.notFound">No Estados found</Translate>
            </div>
          )
        )}
      </div>
