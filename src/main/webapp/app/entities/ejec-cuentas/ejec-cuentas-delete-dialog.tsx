...
export const EjecCuentasDeleteDialog = (props: IEjecCuentasDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFlutterApp.ejecCuentas.delete.question">
        <Translate contentKey="jhipsterFlutterApp.ejecCuentas.delete.question" interpolate={{ id: ejecCuentasEntity.id }}>
          Are you sure you want to delete this EjecCuentas?
        </Translate>
      </ModalBody>
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-ejecCuentas" color="danger" onClick={confirmDelete}>
