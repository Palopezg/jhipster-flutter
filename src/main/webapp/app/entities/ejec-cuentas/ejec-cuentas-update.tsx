  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterFlutterApp.ejecCuentas.home.createOrEditLabel">
            <Translate contentKey="jhipsterFlutterApp.ejecCuentas.home.createOrEditLabel">Create or edit a EjecCuentas</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : ejecCuentasEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="ejec-cuentas-segmento">
