...
export const DireccionDeleteDialog = (props: IDireccionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFlutterApp.direccion.delete.question">
        <Translate contentKey="jhipsterFlutterApp.direccion.delete.question" interpolate={{ id: direccionEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-direccion" color="danger" onClick={confirmDelete}>
