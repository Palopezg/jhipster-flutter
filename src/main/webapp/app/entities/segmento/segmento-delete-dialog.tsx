...
export const SegmentoDeleteDialog = (props: ISegmentoDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFlutterApp.segmento.delete.question">
        <Translate contentKey="jhipsterFlutterApp.segmento.delete.question" interpolate={{ id: segmentoEntity.id }}>
          Are you sure you want to delete this Segmento?
        </Translate>
      </ModalBody>
      <ModalFooter>
