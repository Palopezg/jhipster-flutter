  ...
  return (
    <div>
      <h2 id="segmento-heading">
        <Translate contentKey="jhipsterFlutterApp.segmento.home.title">Segmentos</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterFlutterApp.segmento.home.createLabel">Create new Segmento</Translate>
        </Link>
      </h2>
        ...
        {segmentoList && segmentoList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterFlutterApp.segmento.home.notFound">No Segmentos found</Translate>
            </div>
          )
        )}
      </div>
