...
export const TecnologiaDeleteDialog = (props: ITecnologiaDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFlutterApp.tecnologia.delete.question">
        <Translate contentKey="jhipsterFlutterApp.tecnologia.delete.question" interpolate={{ id: tecnologiaEntity.id }}>
          Are you sure you want to delete this Tecnologia?
        </Translate>
      </ModalBody>
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-tecnologia" color="danger" onClick={confirmDelete}>
