...
export const CompetenciaDeleteDialog = (props: ICompetenciaDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFlutterApp.competencia.delete.question">
        <Translate contentKey="jhipsterFlutterApp.competencia.delete.question" interpolate={{ id: competenciaEntity.id }}>
