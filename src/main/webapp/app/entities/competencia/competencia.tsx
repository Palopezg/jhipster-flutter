  ...
  return (
    <div>
      <h2 id="competencia-heading">
        <Translate contentKey="jhipsterFlutterApp.competencia.home.title">Competencias</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterFlutterApp.competencia.home.createLabel">Create new Competencia</Translate>
        </Link>
      </h2>
        ...
        {competenciaList && competenciaList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterFlutterApp.competencia.home.notFound">No Competencias found</Translate>
            </div>
          )
        )}
      </div>
